...
public class IteratorOfIteratorsTest {
    ...
    @Test
    public void whenIteratorsContainDifferentAmountNumbers() {
        ...
        Iterator<Iterator<Integer>> its = Arrays.asList(it1, it2, it3).iterator();
        Converter iteratorOfIterators = new Converter();
        Iterator<Integer> iterator = iteratorOfIterators.convert(its);
        while (iterator.hasNext()) {
            stringJoiner.add(String.valueOf(iterator.next()));
        }
        assertThat(stringJoiner.toString(), is("4 2 0 4 6 4 9 0 9 8 7 5 1 3 5 6 7 0 9 8 4"));
    }
